                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card height">
                            <div class="card-body ">
                                <div class="fs-5 text-warning"><strong>Welcome to Crispy Fried Chicken</strong></div>
                                <div class="text-muted text-warning fs-6">Create New Account</div>
                                <div class="first-input mt-3 " v-if="first_input">
                                <div class="text-center text-warning fs-5 mt-3">
                            ...
                            <div class="text-center">
                                I already have an <router-link class="custom-link" to="/Login">Account</router-link>
                            </div>
                            </div>
                        </div>
                    </div>
